...
const WarningModal: React.FC<Props> = ({
    ...
    return (
        <div
            ...
            className="fixed inset-0 z-[99999] flex items-center justify-center p-5 overflow-y-auto"
        >
            {/* Backdrop */}
            <div
                className="fixed inset-0 h-full w-full bg-gray-400/50 dark:bg-gray-900/50 backdrop-blur-xs transition-opacity duration-500 ease-in-out"
                onClick={onClose}
            />
            ...
            >
                ...
                <div className="text-center">
                    ...
                    <h4 id="warning-modal-title" className="mb-2 text-2xl font-semibold text-gray-800 dark:text-white/90 sm:text-title-sm">
                        {title}
                    </h4>

                    <p id="warning-modal-desc" className="text-sm leading-6 text-gray-500 dark:text-gray-400">
                        {message}
                    </p>
